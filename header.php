...
<body>
    <header>      
        <nav class="navbar fixed-top navbar-expand-lg navbar-light">
            <a class="logo_icon ml-3 pt-1 pb-1" href="index.php"><img src="image/EZO.png" width="100" alt=""></a>
            <button class="navbar-toggler" id="burger" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto topnav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  font-weight-bold" href="about-us.php">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  font-weight-bold" href="contact-us.php">Contact</a>
                    </li>                        
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item font-weight-bold" href="aml-policy.php">AML Policy</a>
                            <a class="dropdown-item font-weight-bold" href="privacy-policy.php">Privacy Policy</a>
                            <a class="dropdown-item font-weight-bold" href="terms-of-use.php">Terms of Use</a>
                        </div>
                    </li>                        
                    <!-- <li class="nav-item">
